...
<div class="wrap">
  ...
  <section>
    ...
    <div class="caso">
      <div class="caso__cima"><span class="caso__n">0</span>
    ...
    <div class="caso">
      <div class="caso__cima"><span class="caso__n">0<span class="dim">bis</span></span>
  ...
  <section>
    ...
    <div class="caso">
      ...
      <ol class="passi">
        ...
        <li>Premi <span class="tasti">Ctrl</span> + <span class="tasti">V</span>:
          il PDF della fattura si allega da solo.</li>
        <li>Premi <span class="tasti">Invio</span> e il documento &egrave; partito.</li>
      </ol>
      <div class="nota nota--info">
        <span class="nota__i">&#10003;</span>
        <div><strong>Perch&eacute; quel Ctrl+V?</strong> WhatsApp non permette a un programma
        di attaccare file da solo. Il gestionale allora ti mette il PDF
        <em>negli appunti</em>, cos&igrave; incollarlo &egrave; un gesto solo. &Egrave; anche l'ultima
        occasione per controllare che stai scrivendo alla persona giusta.</div>
      </div>
      <p class="risultato"><b>Se qualcosa non torna &rarr;</b> Il PDF resta salvato nella
      cartella <strong>dati &rarr; da_inviare</strong>, accanto al programma: puoi sempre
      allegarlo a mano con la <strong>graffetta</strong> di WhatsApp. La pagina di invio
      ti dice il nome esatto del file.</p>
  ...
  <section>
    ...
    <div class="caso">
      <p><strong>Chiudi il browser e basta.</strong> Il gestionale si accorge che non
      ci sono pi&ugrave; pagine aperte e <strong>si spegne da solo</strong> dopo qualche
      minuto. Non devi fare altro.</p>
      <p>Se vuoi chiuderlo subito, in fondo a ogni pagina c'&egrave; il pulsante
        <span class="bottone chiaro">&#9211; Chiudi il gestionale</span>.</p>
      <div class="nota nota--info">
        <span class="nota__i">&#10003;</span>
        <div>Pu&ograve; capitare, se lasci la pagina aperta e non la guardi per molto tempo,
        che si spenga da solo: te lo scrive in fondo allo schermo. Non &egrave; un guaio e
        <strong>non si perde niente</strong> &mdash; riaprilo col doppio clic sull'icona.</div>
      </div>
    </div>
  </section>
    ...
    <div class="caso">
      <ol class="passi">
        ...
        <li><strong>Premo "Apri WhatsApp" e non si apre niente.</strong> Vuol dire che
          ...
          <strong>0bis</strong>. Controlla anche che il telefono sia accesso e connesso.</li>
        <li><strong>Ho premuto Ctrl+V e non si allega nulla.</strong> Clicca prima
          <em>dentro</em> il campo del messaggio, poi riprova. Se ancora niente, allega il
          PDF con la <strong>graffetta</strong>: lo trovi nella cartella
